...
namespace TP_Ogame.Controllers
{
    public class RessourcesController : Controller
    {
        private TP_OgameContext db = new TP_OgameContext();
        ...
        public ActionResult Create([Bind(Include = "Id")] Ressource ressource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id")] Ressource ressource)
        {
            if (ModelState.IsValid)
            {
